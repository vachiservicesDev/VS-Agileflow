...
export default function PlanningPoker() {
  ...
  useEffect(() => {
    ...
    // Initialize or join room based on whether user is host
    if (isHost && roomState?.type !== 'planning-poker') {
      // Room should already be initialized from CreateRoom page
    }
  }, [participantName, isHost, roomState, navigate]);
  ...
  const handleVote = (value: string) => {
    ...
    sendMessage('vote', { participantId: participant.id, value });
  ...
  const handleSetStory = () => {
    ...
    sendMessage('set-story', { story: currentStory.trim() });
  };
